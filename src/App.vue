    ...
    <div class="piece-area">
      ...
      <div v-if="!gameStarted" class="start-message">
        <div class="start-controls">
          ...
          <button @click="openSettings" class="settings-button" title="Settings">
          ...
          <div class="setting-group">
            ...
            <div class="radio-group">
              <label class="radio-option">
                <input type="radio" v-model="captureKingMode" :value="false">
                <span>Capture Enemy Pieces</span>
              </label>
              <label class="radio-option">
                <input type="radio" v-model="captureKingMode" :value="true">
                <span>Capture the King (Checkmate)</span>
              </label>
            </div>
          </div>
